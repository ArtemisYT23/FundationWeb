...
import {
  ...
  getFilterVideoSelected,
} from "../../../../redux/States/Video";
import { VideoCreatedModal } from "../Modal/ModalCreate";
import { VideoUpdateModal } from "../Modal/ModalUpdate";
import { VideoDeleteModal } from "../Modal/ModalDelete";

export const BodyVideo = () => {
  ...
  const EditTypeFile = (props) => {
    const invokeParentMethod = () => {
      dispatch(getFilterVideoSelected(props.node.data.id, "edit"));
    };
  ...
  const DeleteTypeFile = (props) => {
    const invokeParentMethod = () => {
      dispatch(getFilterVideoSelected(props.node.data.id, "delete"));
    };
  ...
  const OpenModalComentaryCreated = () => {
    dispatch(openModalCreatedVideo(true));
  };
