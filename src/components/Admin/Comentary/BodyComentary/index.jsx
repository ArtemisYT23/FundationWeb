...
import {
  ...
  getFilterComentarySelected,
} from "../../../../redux/States/Comentary";
import { ComentaryCreatedModal } from "../Modal/ModalCreate";
import { ComentaryUpdateModal } from "../Modal/ModalUpdate";
import { ComentaryDeleteModal } from "../Modal/ModalDelete";

export const BodyComentary = () => {
  ...
  const EditTypeFile = (props) => {
    const invokeParentMethod = () => {
      dispatch(getFilterComentarySelected(props.node.data.id, "edit"));
    };
  ...
  const DeleteTypeFile = (props) => {
    const invokeParentMethod = () => {
        dispatch(getFilterComentarySelected(props.node.data.id, "delete"));
    };
  ...
  const OpenModalComentaryCreated = () => {
    dispatch(openModalCreatedComentary(true));
  };
  ...
  return (
    <ContainerIndex>
      ...
      <TableContainer>
       ...
       <ComentaryCreatedModal />
      <ComentaryUpdateModal />
      <ComentaryDeleteModal />
